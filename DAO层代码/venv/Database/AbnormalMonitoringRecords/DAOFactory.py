from SQLAbnormalMonitoringRecordsDAO import SQLAbnormalMonitoringRecordsDAO
import pyodbc
from dbutils.persistent_db import PersistentDB

class DAOFactory:
    @staticmethod
    def create_abnormalMonitoringRecords_dao():
        # 创建PersistentDB对象
        POOL = PersistentDB(
        ...
        return SQLAbnormalMonitoringRecordsDAO(conn)
